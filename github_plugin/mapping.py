...
class Field(BaseField):
    ...
    def fetch_fieldtype_info(self):
        ...
        if attribute_type == 'Text':
            ...
            list =transformer_functions.get_field_value(self.instance_obj,details=self.instance_details,repo=self.fields_obj.project_info['display_name'])
            value_list = []
            for values in list:
...
class AssetsManage(BaseAssetsManage):
    def fetch_org(self):
        response_repos= transformer_functions.get_org(self.instance_obj)
        projects = [
...
class WebHook(BaseWebHook):
    ...
    def create_webhook(self, webhook_name, webhook_url,webhook_description):
        ...
        for repo in self.project_names:
            transformer_functions.webhooks(self.instance_obj,self.instance_details,repo
